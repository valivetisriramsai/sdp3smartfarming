    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
		  ...
		  <li><a class="nav-link scrollto" href="#">ADMIN LOGGEDIN SUCCESSFULLY!</a></li>
     ...
     <style>
body {
  background-image: url('views/back3.jpg');
  ...
  <!-- ======= Latest Technologies Section ======= -->
    <section id="services" class="services">
      <div class="container" data-aos="fade-up">
       ...
       <a href="addservice">ADD Technology</a>
          <h3>Check our <span>Technologies</span></h3>
          <a href="getallarts" style="color=blue">VIEW Technologies </a>
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
            <div class="member">
              <div class="member-img">
                <img src="views/team/team-1.jpg" class="img-fluid" alt="">
                <div class="social">
    ...
    <section id="faq" class="faq section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          ...
          <p>Questions asked frequently about the smart farming</p>
        </div>
        ...
        <div class="row justify-content-center">
          <div class="col-xl-10">
            <ul class="faq-list">
              ...
              <li>
                <div data-bs-toggle="collapse" href="#faq2" class="collapsed question">What does smart farming aim to? <i class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i></div>
                <div id="faq2" class="collapse" data-bs-parent=".faq-list">
                  <p>
                  The goal of smart farming is to make every aspect of farming more reliable, predictable and sustainable. Achieving this goal has long been the dream of every farme
                     </p>
                </div>
              </li>

              <li>
                <div data-bs-toggle="collapse" href="#faq3" class="collapsed question">What are the technology used for smart farming? <i class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i></div>
              ...
              <li>
                <div data-bs-toggle="collapse" href="#faq4" class="collapsed question">What is smart agriculture climate?<i class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i></div>
              ...
              <li>
                <div data-bs-toggle="collapse" href="#faq5" class="collapsed question">How can smart farm improve our lives? <i class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i></div>
                <div id="faq5" class="collapse" data-bs-parent=".faq-list">
                  <p>
                  Tech providers are helping them with tools such as drone imagery and soil sensors, which measure real-time conditions
                    </p>
                </div>
              </li>

              <li>
                <div data-bs-toggle="collapse" href="#faq6" class="collapsed question">What is agriculture automation? <i class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i></div>
                <div id="faq6" class="collapse" data-bs-parent=".faq-list">
                  <p>
                  Agricultural automation is the core technology for computer-aided agricultural production management and implementation
                    </p>
                </div>
              </li>
    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          ...
          <p>Contact us If you have any queries related to Smart Farming</p>
        </div>
